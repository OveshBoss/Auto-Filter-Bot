...
# Bot information
API_ID = environ.get('API_ID', '28282067')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5215993250')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '3013813223')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/+Xy5mlr1BZlAxZjVl')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://Ovesh:ovesh.boss@ovesh.95jpp8g.mongodb.net/?retryWrites=true&w=majority&appName=Ovesh")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/MG_movie')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+8z5Z-Tc8P7w3YTRl')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+8z5Z-Tc8P7w3YTRl')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003169061900")
